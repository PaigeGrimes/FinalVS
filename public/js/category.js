...
const CATEGORY_CONFIGS = {
  ...
  'meet-people': {
    ...
    'hidden-gems': {
        name: 'Hidden Gems',
        title: 'Hidden Gems - Niche locations in Sarasota',
        description: 'Uncover Sarasota\'s unique dining, secret hangouts, and authentic experiences\n' +
            '            beyond the tourist trail.',
        dataFile: 'hidden-gems.json',
        icon: '💎'
    }
};
